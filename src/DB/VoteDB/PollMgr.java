...
public class PollMgr {
	...
	public PollMgr() {
		try {
			...
			pool = (DataSource)context.lookup("java:comp/env/jdbc/oracle");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public boolean insertPoll(PollListBean plBean, PollItemBean piBean) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		boolean flag = false;
		String sql = null;
		try {
			...
			sql = "insert into tblPollList(num, question, sdate, edate, wdate, type)"
					+ "values(auto_seq.NEXTVAL,?,?,?,SYSDATE,?)";
			pstmt = con.prepareStatement(sql);
	...
	public Vector<PollListBean> getAllList() throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public PollListBean getList(int num) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public Vector<String> getItem(int num) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public boolean updatePoll(int num, String[] itemnum) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		boolean flag = false;
		String sql = null;
	...
	public Vector<PollItemBean> getView(int num) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public int sumCount(int num) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
